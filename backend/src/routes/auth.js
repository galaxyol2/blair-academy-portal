...
function buildAuthRouter() {
  ...
  const scheduleCatalog = [
    { name: "Nutrition & Healthy Living", time: "", instructor: "Professor Melly", category: "course" },
    { name: "Photography & Digital Imaging", time: "", instructor: "Professor Glo", category: "course" },
    { name: "Introduction to Journalism", time: "", instructor: "Professor Twan", category: "course" },
    { name: "Introduction To Psychology", time: "", instructor: "Professor Prices", category: "course" },
    { name: "Sexual & Reproductive Health", time: "", instructor: "Professor Kim", category: "elective" },
    { name: "Literature & Film", time: "", instructor: "Professor Chosen", category: "course" },
